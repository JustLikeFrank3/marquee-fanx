    ...
    <main>
      ...
      <section className="hero wrap"><div className="hero-heading"><div><p className="eyebrow orange">GOOD NIGHTS START HERE</p><h1>A night out,<br/><em>found.</em></h1></div><p className="lede">Find your kind of live. <br/>Compare the options.<br/><span>Check the facts behind the pick.</span></p></div>
        <form onSubmit={e=>{e.preventDefault();run();}}>
          <div className="searchbox"><span aria-hidden="true">⌕</span><input aria-label="Artist, event or venue" placeholder="An artist, an event, a place. What sounds good?" value={search.query} onChange={e=>update('query',e.target.value)} maxLength={160}/><button className="accent" disabled={!!busy}>Find my night</button></div>
